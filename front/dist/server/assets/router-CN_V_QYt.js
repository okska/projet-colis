...
const appCss = "/assets/app-BYrTvrxo.css";
const seo = ({
  title,
  description,
  keywords,
...
const $$splitComponentImporter$i = () => import("./users-C-tGQiag.js");
const Route$n = createFileRoute("/users")({
  loader: async () => {
...
const Route$m = createFileRoute("/redirect")({
  beforeLoad: () => {
    throw redirect({
      to: "/posts"
    });
...
const $$splitComponentImporter$h = () => import("./posts2-BL4AwPYx.js");
const Route$l = createFileRoute("/posts2")({
...
async function fetchPosts2() {
  ...
  const res = await fetch(`${apiUrl$2}/api/posts2`);
  if (!res.ok) {
...
const fetchPost = async (postId) => {
  ...
  const res = await fetch(`${apiUrl$1}/api/posts/${postId}`);
  if (!res.ok) {
    if (res.status === 404) {
      throw notFound();
    }
...
const fetchPosts = async () => {
  ...
  const res = await fetch(`${apiUrl$1}/api/posts`);
  if (!res.ok) {
...
const $$splitComponentImporter$g = () => import("./posts-r44K5g9n.js");
const Route$k = createFileRoute("/posts")({
...
const $$splitComponentImporter$f = () => import("./mes-listings-wqdA6vTg.js");
const Route$j = createFileRoute("/mes-listings")({
  loader: async ({
    context
  }) => {
    const serverCookie = typeof document === "undefined" ? context?.serverContext?.request?.headers.get("cookie") ?? void 0 : void 0;
...
const $$splitComponentImporter$e = () => import("./listings-C7DA9vBh.js");
const Route$i = createFileRoute("/listings")({
...
const $$splitComponentImporter$d = () => import("./deferred-DEJgltdR.js");
...
const $$splitComponentImporter$c = () => import("./auth-CcxW2vf0.js");
const Route$f = createFileRoute("/auth")({
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./_pathlessLayout-BhrcpZGS.js");
const Route$e = createFileRoute("/_pathlessLayout")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./index-CgEsgH9O.js");
const Route$d = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./users.index-Bef-9o5f.js");
const Route$c = createFileRoute("/users/")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./posts.index-DU8oxB5n.js");
const Route$b = createFileRoute("/posts/")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./listings.index-fdjvedSS.js");
const Route$a = createFileRoute("/listings/")({
  loader: async () => {
...
const $$splitNotFoundComponentImporter$1 = () => import("./users._userId-CXmxcSkF.js");
const $$splitComponentImporter$6 = () => import("./users._userId-BhF7599q.js");
...
const $$splitNotFoundComponentImporter = () => import("./posts._postId-7tM3mMPC.js");
const $$splitComponentImporter$5 = () => import("./posts._postId-CyCa-z9b.js");
...
const $$splitComponentImporter$4 = () => import("./listings.new-B277BxVh.js");
const Route$7 = createFileRoute("/listings/new")({
...
const $$splitComponentImporter$2 = () => import("./posts_._postId.deep-BBejeONP.js");
...
const UsersRoute = Route$n.update({
  id: "/users",
  path: "/users",
  getParentRoute: () => Route$o
});
const RedirectRoute = Route$m.update({
  id: "/redirect",
  path: "/redirect",
  getParentRoute: () => Route$o
});
const Posts2Route = Route$l.update({
  id: "/posts2",
  path: "/posts2",
  getParentRoute: () => Route$o
});
const PostsRoute = Route$k.update({
  id: "/posts",
  path: "/posts",
  getParentRoute: () => Route$o
});
const MesListingsRoute = Route$j.update({
  id: "/mes-listings",
  path: "/mes-listings",
  getParentRoute: () => Route$o
});
const ListingsRoute = Route$i.update({
  id: "/listings",
  path: "/listings",
  getParentRoute: () => Route$o
});
...
const ListingsIndexRoute = Route$a.update({
  id: "/",
  path: "/",
...
const ListingsNewRoute = Route$7.update({
  id: "/new",
  path: "/new",
  getParentRoute: () => ListingsRoute
});
